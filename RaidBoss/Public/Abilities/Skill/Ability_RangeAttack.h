...
protected:
    ...
    void    SetTracePointsFromWeapon(OUT FVector& OutStartPoint,OUT FVector& OutEndPoint,
                                  const TArray<FHitResult>& HitResultRef);

    bool    StartTracingFromCamera(const FVector& StartPoint, const FVector& EndPoint,
                                OUT TArray<FHitResult>& OutHitResults);
