...
TArray<AActor*> URaidBossLibrary::GetActorsInAngle(const UObject* WorldContextObject, const FVector& Location,
                                                   ...
                                                   float Angle/* = 45*/, bool bIgnoreDistanceZ/* = true*/,
                                                   bool DrawDebug/* = false*/)
{
    ...
    if (DrawDebug)
    {
        ...
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, Location,
                                              Location + FRotator(0, Angle / 2, 0).RotateVector(Direction) * Radius,
                                              TraceTypeQuery1, false, TMP, EDrawDebugTrace::ForDuration, HitResult,
                                              true);
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, Location,
                                              Location + FRotator(0, -Angle / 2, 0).RotateVector(Direction) * Radius,
                                              TraceTypeQuery1, false, TMP, EDrawDebugTrace::ForDuration, HitResult,
...
TArray<AActor*> URaidBossLibrary::GetActorsInRectangle(const UObject* WorldContextObject, const FVector& Location,
                                                       ...
                                                       const TArray<TSubclassOf<AActor>>& FilterClasses,
                                                       const TArray<TSubclassOf<AActor>>& IgnoreClasses,
                                                       bool bIgnoreDistanceZ, bool DrawDebug)
{
    TArray<AActor*> Result;
    ...
    if (DrawDebug)
    {
        ...
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, Location, FwdEnd, TraceTypeQuery1, false, TMP,
                                              EDrawDebugTrace::ForDuration, HitResult, true);
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, Location, LeftStart, TraceTypeQuery1, false, TMP,
                                              EDrawDebugTrace::ForDuration, HitResult, true);
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, Location, RightEnd, TraceTypeQuery1, false, TMP,
                                              EDrawDebugTrace::ForDuration, HitResult, true);
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, RightEnd, StartRight, TraceTypeQuery1, false, TMP,
                                              EDrawDebugTrace::ForDuration, HitResult, true);
        UKismetSystemLibrary::LineTraceSingle(WorldContextObject, StartRight, StartRight + RightToLeft, TraceTypeQuery1,
                                              false, TMP, EDrawDebugTrace::ForDuration, HitResult, true);
    }
...
FVector URaidBossLibrary::GetFloorLocation(const UObject* WorldContextObject, const FVector& StartLocation,
                                           float TraceLength, bool bDrawDebugLine)
{
    ...
    FHitResult              HitResult;
    bool                    bWasHit =
        UKismetSystemLibrary::LineTraceSingleForObjects(WorldContextObject, StartLocation,
                                                        StartLocation + DownVector,
                                                        {UEngineTypes::ConvertToObjectType(ECC_WorldStatic)},
                                                        false, {}, DebugTrace, HitResult, true);
...
bool URaidBossLibrary::LineTraceForObjectFromCamera(const UObject* WorldContextObject,
                                                    ...
                                                    FVector& OutTraceEndLocation, bool bIgnoreSelf, float TraceLength,
                                                    bool bDrawDebugLine)
{
    ...
    return UKismetSystemLibrary::LineTraceSingleForObjects(WorldContextObject, CameraLocation,
                                                           OutTraceEndLocation, ObjectTypes, false, ActorsToIgnore,
                                                           DrawDebugType, OutHit,
                                                           bIgnoreSelf);
}

bool URaidBossLibrary::GetVelocityToLaunchActor(const UObject* WorldContextObject, FVector& OutLaunchVelocity,
                                                FVector StartPos, FVector EndPos, float ArcParam,
                                                float OverrideGravityZ)
{
    return UGameplayStatics::SuggestProjectileVelocity_CustomArc(WorldContextObject, OutLaunchVelocity, StartPos,
                                                                 EndPos, OverrideGravityZ, ArcParam);
}

UParticleSystemComponent* URaidBossLibrary::SpawnEmitterAtLocation(UWorld* World, UParticleSystem* EmitterTemplate,
                                                                   const FTransform& SpawnTransform, bool bAutoDestroy,
                                                                   EPSCPoolMethod PoolingMethod,
                                                                   bool bAutoActivateSystem)
{
    return UGameplayStatics::SpawnEmitterAtLocation(World, EmitterTemplate, SpawnTransform, bAutoDestroy, PoolingMethod,
                                                    bAutoActivateSystem);
}
