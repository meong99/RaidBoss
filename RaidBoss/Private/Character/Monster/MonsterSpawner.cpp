...
void AMonsterSpawner::Tick(float DeltaTime)
{
    ...
    if (Timer >= SpawnTimeCycle && GetCurrentSpawnedMonsterNumber() < MaximumSpawnMonster)
    {
        Timer = 0;
...
bool AMonsterSpawner::SpawnMonster()
{
    ...
    {
        AMonsterBase* SpawnedMonster = CurrentWorld->SpawnActorDeferred<AMonsterBase>(
            MonsterInfo->MonsterClass, FTransform::Identity, this);
