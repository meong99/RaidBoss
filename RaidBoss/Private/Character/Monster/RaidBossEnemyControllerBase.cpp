...
ARaidBossEnemyControllerBase::ARaidBossEnemyControllerBase()
{
    ...
    PerceptionComponent->OnTargetPerceptionUpdated.AddDynamic(
        this, &ARaidBossEnemyControllerBase::OnTargetDetectedDelegated);
}
...
void ARaidBossEnemyControllerBase::Tick(float DeltaSeconds)
{
    ...
    float bIsNotInChasingRange = ControlledMonster->GetDistanceBetweenSpawner() > ControlledMonster->
        GetMaxChasingDistance();
...
void ARaidBossEnemyControllerBase::OnTargetDetectedDelegated(AActor* Actor, FAIStimulus Stimulus)
{
    ...
    bool bIsNotInChasingRange = ControlledMonster->GetDistanceBetweenSpawner() > ControlledMonster->
        GetMaxChasingDistance();
