...
{
    ARaidBossCharacterBase*             CharacterBase = Cast<ARaidBossCharacterBase>(GetOwningPlayerPawn());
    URaidBossAbilitySystemComponent*    AbilitySystemComponent = CharacterBase
                                                                 ? CharacterBase->GetRaidBossAbilitySystemComponent()
                                                                 : nullptr;
    ...
    URaidBossAbilityBase* AbilityBase = AbilitySystemComponent->GetInstanceAbilitiesByTag().FindRef(
        NewItemCDO->GetAbilityTriggerTag());
