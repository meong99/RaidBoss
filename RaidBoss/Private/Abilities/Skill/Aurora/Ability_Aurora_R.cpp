                                        ...
                                        const FGameplayEventData* TriggerEventData)
{
	...
	else
	{
		...
		UAbilityTask_WaitGameplayEvent*		WaitGameplayEvent = CreateWaitGameplayEventTask(RaidBossGameplayTags::Get().Animation_Notify_AttackPoint);
		UAT_FloatingActor* FloatingActorTask = UAT_FloatingActor::CreateFloatingActorTask(this, FloatingHeight, RisingSpeed, FloatingTime, FallingSpeed);
