...
void UAbility_RangeAttack::SetTracePointsFromWeapon(FVector& OutStartPoint, FVector& OutEndPoint,
                                                    const TArray<FHitResult>& HitResultRef)
{
                                                  ...
                                                  TArray<FHitResult>& OutHitResults)
{
    ...
    EDrawDebugTrace::Type   drawDebugTrace = 0.f < DrawDebugDuration
...
void UAbility_RangeAttack::ApplyEffectToTarget(AActor* TargetActor)
{
    ...
    TArray<FActiveGameplayEffectHandle> EffectHandles = ApplyGameplayEffectToTarget(CurrentSpecHandle, CurrentActorInfo,
                                                                                    CurrentActivationInfo, TargetData,
                                                                                    EffectClass, 1);
}
