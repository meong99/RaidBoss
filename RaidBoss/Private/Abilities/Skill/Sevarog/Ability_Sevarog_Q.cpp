                                         ...
                                         const FGameplayEventData* TriggerEventData)
{
    ...
    UAbilityTask_WaitGameplayEvent* WaitGameplayEvent =
        CreateWaitGameplayEventTask(RaidBossGameplayTags::Get().Animation_Notify_AttackPoint, false);
...
TArray<AActor*> UAbility_Sevarog_Q::StartTraceAndGetTargets()
{
    ...
    return URaidBossLibrary::GetActorsInRectangle(this, OwnerCharacter->GetActorLocation(),
                                                  UKismetMathLibrary::GetForwardVector(FRotator{0, OwnerCharacter->GetControlRotation().Yaw, 0}),
                                                  SkillRange, SkillSideRange,
