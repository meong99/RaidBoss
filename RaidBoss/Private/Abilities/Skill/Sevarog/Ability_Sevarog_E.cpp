...
void UAbility_Sevarog_E::SetIndicator()
{
	for (auto Indicator : TestIndicators)
	{
		...
		{
			UAT_SpawnActorAndFollowCamera* SpawnActorAndFollowCamera = UAT_SpawnActorAndFollowCamera::SpawnActorAndFollowCamera(
...
FVector UAbility_Sevarog_E::GetFloorAtCameraTracingLocation() const
{
	...
	bool bTracingComplete = URaidBossLibrary::LineTraceForObjectFromCamera(this, OwnerCharacter, {UEngineTypes::ConvertToObjectType(ECC_WorldStatic)},
