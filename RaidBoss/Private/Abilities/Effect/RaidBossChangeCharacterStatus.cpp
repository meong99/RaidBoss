...
void URaidBossChangeCharacterStatus::SaveAggregatorFromExecutedSpec(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    ...
    for (auto CurExecDef : ExecutionFromDef)
    {
        ...
        {
            float   ExcutedValue;
            bool    bIscalculationSuccessed =
                CurScopedMod.ModifierMagnitude.AttemptCalculateMagnitude(ExecutionParams.GetOwningSpec(),
                                                                         ExcutedValue);
...
void URaidBossChangeCharacterStatus::CheckAndApplyHealth(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams,
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
void URaidBossChangeCharacterStatus::CheckAndApplyMaxHealth(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams,
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
void URaidBossChangeCharacterStatus::CheckAndApplyMana(const FGameplayEffectCustomExecutionParameters& ExecutionParams,
                                                       FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
void URaidBossChangeCharacterStatus::CheckAndApplyMaxMana(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams,
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
    float   BonusValue = GetBonusMaxManaFromExecutedSpec(StatusStatic().MaxManaDef);
...
void URaidBossChangeCharacterStatus::CheckAndApplyAttackPower(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams,
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
void URaidBossChangeCharacterStatus::CheckAndApplyDefencePower(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams,
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
void URaidBossChangeCharacterStatus::SetProperty(FGameplayEffectCustomExecutionOutput& OutExecutionOutput,
                                                 ...
                                                 TEnumAsByte<EGameplayModOp::Type> ModifierOp, float Magnitude) const
{
...
float URaidBossChangeCharacterStatus::GetBaseHealth(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;
...
float URaidBossChangeCharacterStatus::GetBaseMaxHealth(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;
...
float URaidBossChangeCharacterStatus::GetBaseMaxMana(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;
...
float URaidBossChangeCharacterStatus::GetBaseAttackPower(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;
...
float URaidBossChangeCharacterStatus::GetBonusHealthAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    FAggregatorEvaluateParameters EvaluateParameters;
    float   OutValue = 0;

    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().HealthDef, EvaluateParameters,
                                                                    OutValue);

    return OutValue;
}

float URaidBossChangeCharacterStatus::GetBonusMaxHealthAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    FAggregatorEvaluateParameters EvaluateParameters;
    float   OutValue = 0;

    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().MaxHealthDef, EvaluateParameters,
                                                                    OutValue);

    return OutValue;
}

float URaidBossChangeCharacterStatus::GetBonusManaAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;

    FAggregatorEvaluateParameters EvaluateParameters;
    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().ManaDef, EvaluateParameters,
                                                                    OutValue);

    return OutValue;
}

float URaidBossChangeCharacterStatus::GetBonusMaxManaAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    float   OutValue = 0;

    FAggregatorEvaluateParameters EvaluateParameters;
    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().MaxManaDef, EvaluateParameters,
                                                                    OutValue);

    return OutValue;
}

float URaidBossChangeCharacterStatus::GetBonusAttackPowerAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    FAggregatorEvaluateParameters   EvaluateParameters;
    float                           OutValue = 0;

    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().AttackPowerDef, EvaluateParameters,
                                                                    OutValue);

    return OutValue;
}

float URaidBossChangeCharacterStatus::GetBonusDefensePowerAllExecuted(
    const FGameplayEffectCustomExecutionParameters& ExecutionParams) const
{
    FAggregatorEvaluateParameters   EvaluateParameters;
    float                           OutValue = 0;
    
    ExecutionParams.AttemptCalculateCapturedAttributeBonusMagnitude(StatusStatic().DefensePowerDef, EvaluateParameters,
                                                                    OutValue);
